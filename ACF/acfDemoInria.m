...
dataDir = '/home/yuxiang/Projects/INRIAPerson/';
addpath(dataDir);
...
for s = 1:2
  ...
  if exist([dataDir type '/posGt'], 'dir')
      continue;
  end
...
if( 0 )
  detector1 = acfModify(detector,'pad',[0 0]);
  n = 60;
  Is = cell(1,n);
  for i = 1:n
      Is{i} = imResample(imread(imgNms{i}), [480 640]);
  end
  tic;
  for i = 1:n
      acfDetect(Is{i},detector1);
  end
