function greedy_occlusion_reasoning_3drr(varargin)
...
if is_train
    ...
    detfile = fullfile(rootpath, 'ACF/kitti_test_acf_3d_227_flip/car_3d_ap_227_combined_3drr.mat');
...
for idx = 1:N
    ...
    % prepare data
    filename = fullfile(outpath, [num2str(idx, '%06d') '_3drr.mat']);
    if exist(filename) ~= 0
...
filename = fullfile(outpath, 'odets_3drr.mat');
