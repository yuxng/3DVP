function exemplar_compute_segmentation_overlap_dpm
...
filename = sprintf('%s/car_pose_16_test_09.mat', result_dir);
object = load(filename);
detections = object.boxes1;
parts = object.parts1;
...
for i = 1:M
    ...
    % read ground truth
    filename = sprintf('../KITTI/Annotations/%06d.mat', img_idx);
    object = load(filename);
