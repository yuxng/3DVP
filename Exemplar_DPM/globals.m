...
VOCdevkit = '/net/acadia/workplace/yuxiang/Projects/PASCAL3D+_release1.1/PASCAL/VOCdevkit/';

% directory with KITTI development kit and dataset
KITTIroot = '/net/acadia/workplace/yuxiang/Projects/KITTI/data_object_image_2';
KITTIdevkit = '/net/acadia/workplace/yuxiang/Projects/KITTI/devkit/matlab';
addpath(KITTIdevkit);